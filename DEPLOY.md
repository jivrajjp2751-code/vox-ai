# Deployment Guide for Vox AI

This guide explains how to deploy the Vox AI application to a production environment. Since this is a full-stack application (React Frontend + Express Backend + MongoDB), you will need to deploy these components.
...
4.  Get your **Connection String**:
    `mongodb+srv://<username>:<password>@cluster0.mongodb.net/voxai?retryWrites=true&w=majority`
...
Once deployed, you will get a URL like `https://vox-ai-backend.onrender.com`.
...
4.  **Environment Variables**:
    *   `VITE_API_URL`: The URL of your backend (e.g., `https://vox-ai-backend.onrender.com/api`).
